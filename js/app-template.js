...
popoto.provider.nodeProviders = {
    "area": {
        "returnAttributes": ["name", "food_sentiment", "education_sentiment", "healthcare_sentiment"],
        "constraintAttribute": "name"
    },
    "food": {
        "returnAttributes": ["name", "address", "rating", "latitude", "longitude", "website", "icon", "place_id"],
        "constraintAttribute": "name"
    },
    "education": {
        "returnAttributes": ["name", "address", "rating", "latitude", "longitude", "website", "icon", "place_id"],
    ...
    "comment": {
        "returnAttributes": ["comment", "sentiment"],
        "constraintAttribute": "comment"
    }
};
